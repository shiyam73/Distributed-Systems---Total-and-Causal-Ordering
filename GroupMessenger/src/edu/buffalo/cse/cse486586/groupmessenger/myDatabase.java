...
public class myDatabase  extends SQLiteOpenHelper{
	...
	public static final String DB_NAME = "Shiyam.db";
	public static int DB_VERSION= 1;
	public static final String TABLE_NAME= "OrderMessages";
	...
	public static void insertPair(String key, String value, ContentResolver c) {
		...
		c.insert(GroupMessengerProvider.CONTENT_URI, keyValuespair);
	}
